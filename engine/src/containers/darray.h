...
#define darray_destroy(array) _darray_destroy((void *)&array);
...
#define darray_capacity(array) _darray_field_get((void*)&array, DARRAY_CAPACITY)

#define darray_length(array) _darray_field_get((void *)&array, DARRAY_LENGTH)

#define darray_stride(array) _darray_field_get((void*)&array, DARRAY_STRIDE)

#define darray_length_set(array, value)                                        \
    _darray_field_set((void*)&array, DARRAY_LENGTH, value)
