 ...
 * @param delta_time [TODO:parameter]
 */
...
/**
 * Whether a mouse button is unpressed.
 * @param button Button to check.
 */
PAPI b8 input_is_button_up(buttons button);

/**
 * Whether a mouse button was pressed the previous frame.
 * @param button Button to check.
 */
PAPI b8 input_was_button_down(buttons button);

/**
 * Whether a mouse button was unpressed the previous frame.
 * @param button Button to check.
 */
 ...
 * @param x Ptr to x destination.
 * @param y Ptr to y destination.
 */
PAPI void input_get_mouse_pos(i32 *x, i32 *y);

/**
 * The postion of the mouse pointer in the previous frame.
 * @param x Ptr to x destination.
 * @param y Ptr to y destination.
 */
PAPI void input_get_prev_mouse_pos(i32 *x, i32 *y);
...
/**
 * Whether a keyboard key is pressed.
 * @param key Key to check.
 */
PAPI b8 input_is_key_down(keys key);

/**
 * Whether a keyboard key is unpressed.
 * @param key Key to check.
 */
PAPI b8 input_is_key_up(keys key);

/**
 * Whether a keyboard key was pressed the previous grame.
 * @param key Key to check.
 */
PAPI b8 input_was_key_down(keys key);

/**
 * Whether a keyboard key was unpressed the previous game.
 * @param key Key to check.
 */
